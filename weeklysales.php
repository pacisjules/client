...
<head>
    ...
    <title>Weekly Sales - SellEASEP</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-flex flex-row justify-content-between align-items-center">
                        <h3 class="text-dark mb-4" style="font-weight: bold;font-size: 36px; margin-top:25px;">Weekly Sales</h3> <a href="sales.php"><button class="btn btn-primary" type="button" style="font-size: 19px;font-weight: bold; background: rgb(0,26,53); color:white;" ><i class="fas fa-sun"></i>&nbsp;View Daily Sales</button></a>  
                        ...
                        <a href="yearlysales.php"><button class="btn btn-primary" type="button" style="font-size: 19px;font-weight: bold; background: rgb(0,26,53); color:white;" ><i class="far fa-calendar-alt"></i>&nbsp;View Yearly Sales</button></a>
                    </div>
                    <div class="card shadow">
                       
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
    <p class="text-primary m-0 fw-bold">Weekly Sales Records, Week <span id="week"></span> of the Year</p>
    <button class="btn btn-primary" style="font-size: 15px; font-weight: bold;" id="generateWeeklySalesReport">Print Report</button>
</div>
