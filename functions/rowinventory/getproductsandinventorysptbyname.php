...
$sql = "SELECT INVE.id, INVE.quantity, INVE.alert_quantity, INVE.last_updated, PRO.id,
        PRO.status, PRO.sales_point_id, PRO.name, PRO.description
        FROM inventory INVE
        INNER JOIN products PRO ON INVE.product_id = PRO.id
