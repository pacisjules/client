...
//Set master path
$masterHome = "/functions/service/getservicesbycompany.php";
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    //Sales points Get
    if ($_SERVER['REQUEST_URI'] === $masterHome . "/all_services?company=" . $comID) {

        // Retrieve all users from the database
        $sql = "SELECT * FROM services WHERE company_ID=$comID";
