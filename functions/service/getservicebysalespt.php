...
//Set master path
$masterHome = "/functions/service/getservicebysalespt.php";
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    //Sales points Get
    if ($_SERVER['REQUEST_URI'] === $masterHome . "/all_services?company=" . $comID . "&spt=" . $spt) {

        // Retrieve all users from the database
        $sql = "SELECT * FROM services WHERE company_ID=$comID AND sales_point_id=$spt";
