           ...
           // $conn->begin_transaction();
            ...
            for ($i = 0; $i < count($product_ids); $i++) {
                ...
                $total_amount =  $quantity * $custom_price;
                    ...
                    $gresult [] ="PRODUCT: $product_name SESSION: $Session_sale_ID USER: $user_id SPT_ID: $sales_point_id  CUSTOMER: $cust_name PHONE: $phone QTY: $quantity SP: $custom_price TM: $total_amount   ";
                    
                    
                    // Insert sales record
                    $sql = "INSERT INTO `proforma`( `session_id`, `user_id`, `customer_name`, `phone`, `product_name`, `spt_id`, `quantity`, `price`, `total_amount`) 
                    VALUES ('$Session_sale_ID','$user_id','$cust_name','$phone','$product_name','$sales_point_id','$quantity','$custom_price','$total_amount')";
