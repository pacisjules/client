...
//Set master path
$masterHome = "/functions/employee/getemployeebyspt.php";
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    //Sales points Get
    if ($_SERVER['REQUEST_URI'] === $masterHome . "/all_employees?company=" . $comID . "&spt=" . $spt) {
        ...
        FROM employee EM, users US WHERE EM.user_id=US.id AND US.company_ID=$comID AND EM.sales_point_id=$spt";
