...
//Set master path
$masterHome = "/functions/salespoint/getsalesptbyID.php";
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    //Sales points Get
    if ($_SERVER['REQUEST_URI'] === $masterHome . "/all_sales_point?id=" . $id) {

        // Retrieve all users from the database
        $sql = "SELECT * FROM salespoint WHERE 	sales_point_id =$id";
