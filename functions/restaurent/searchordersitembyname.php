...
//Set master path
$masterHome = "/functions/restaurent/searchmenuitembyname.php";
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    //Sales points Get
    if ($_SERVER['REQUEST_URI'] === $masterHome . "/all_menu?company=" . $comID . "&spt=" . $spt . "&Name=" . $Name) {
