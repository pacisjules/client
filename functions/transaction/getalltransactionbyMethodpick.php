...
$sql = "SELECT payments.PaymentMethod,sum(payments.Amount) as totaltransation FROM payments WHERE payments.spt=$spt_id AND payments.PaymentDate LIKE '$date%' GROUP BY payments.PaymentMethod
        ";
