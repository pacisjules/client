...
FROM debts DB, products PD, sales SL, customer CST WHERE DB.product_id=PD.id AND DB.customer_id='$sess_id' AND DB.sales_point_id=$spt AND SL.customer_id='$sess_id' AND CST.customer_id='$sess_id'
GROUP BY DB.id
