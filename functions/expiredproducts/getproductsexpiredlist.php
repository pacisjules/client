...
//Set master path
$masterHome = "/functions/expiredproducts/getproductsexpiredlist.php";
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    //Sales points Get
    if ($_SERVER['REQUEST_URI'] === $masterHome . "/all_wait_expired_list?spt=" . $spt . "&date=" . $date) {
...
FROM
    ...
    WHERE
    EP.sales_point_id=$spt AND EP.expiry_date > '$date%'";
