...
<head>
    ...
    <title>Invoicing Panel - SellEASP</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-flex flex-row justify-content-between align-items-center">
                        <h3 class="text-dark mb-4" style="font-weight: bold;font-size: 36px;">Invoicing Panel</h3>
                    </div>
                    <div class="d-flex">
                        ...
                        <div style="margin-left: 31px;width: 40%;">
                           ...
                           <div><label class="form-label">Search Pending Requests</label><input class="form-control" type="text" placeholder="Search Request ....." id="searcProductingNow">
                           
                           <div style="background: #ededed;box-shadow: -2px 8px 12px 0px rgba(133,135,150,0.45);padding: 6px;padding-left: 13px;" id="getseachrequest">

                                </div>
                              <form >
                                <div>  
                                <label class="form-label" style="margin-top: 12px; font-weight:bold; font-size:12px; color:black;">Car : <span id="gettedcar"></span></label>
                                <label class="form-label" style="margin-top: 12px; font-weight:bold; font-size:12px; color:black;"> Plaque : <span id="gettedplate"></span></label>
                                <label class="form-label" style="margin-top: 12px; font-weight:bold; font-size:12px; color:black;"> Type : <span id="gettedtype"></span></label>
                                </div>
                              <div style="display: flex; align-items: center;">
                                <label class="form-label" style="margin-top: 12px; font-weight:bold; font-size:12px; color:black;">Client : <span id="gettedname"></span></label><br>
                                <label class="form-label" style="margin-top: 12px; font-weight:bold; font-size:12px; color:black;"> Tel : <span id="gettedphone"></span></label><br>
                                <label class="form-label" style="margin-top: 12px; font-weight:bold; font-size:12px; color:black;"> Service : <span id="gettedservice"></span></label>
