...
<body>
    <center>
        <h1 class="text-dark mb-0" style="font-weight: bold; margin-top:10rem;">There is still open shift</h1>
        <h2 class="text-dark mb-0" style="font-weight: bold; margin-top:1rem;">Please contact your workmate to close their shift first</span></h2>
        <br>
