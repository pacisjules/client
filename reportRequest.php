...
<div class="d-flex flex-row justify-content-between align-items-center" style="margin-bottom:20px;">
                       <a href="request.php" ><button class="btn btn-primary"  type="button" style="font-size: 16px;font-weight: bold; background: rgb(0,26,53); color:white;" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar3" viewBox="0 0 16 16">
...
&nbsp;Today</button></a>
                        <button class="btn btn-primary" id="yesterdayrequest" type="button" style="font-size: 16px;font-weight: bold; background: rgb(0,26,53); color:white;" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
  <path d="M8 1 0 8h2v6h12V8h2L8 1zm1 7h5v1H9v4H7V9H3V8h6V7z"/>
</svg>
&nbsp;Yesterday</button>
                        <button class="btn btn-primary" id="pickDateButton" type="button" style="font-size: 16px;font-weight: bold; background: rgb(0,26,53); color:white;" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar-check" viewBox="0 0 16 16">
...
&nbsp;Pick Date</button>
                        <button class="btn btn-primary" type="button" style="font-size: 16px;font-weight: bold; background: rgb(0,26,53); color:white;" id="weeklyrequest" ><i class="fas fa-calendar-week"></i>&nbsp;Weekly</button>
                       <button class="btn btn-primary" id="Pickdaterangebtn" type="button" style="font-size: 16px;font-weight: bold; background: rgb(0,26,53); color:white;" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar2-range" viewBox="0 0 16 16">
...
&nbsp;From To</button>
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#selectMonthModal" type="button" style="font-size: 16px;font-weight: bold; background: rgb(0,26,53); color:white;" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar2-month" viewBox="0 0 16 16">
...
&nbsp;Monthly</button>        
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#selectYearModal" type="button" style="font-size: 16px;font-weight: bold; background: rgb(0,26,53); color:white;" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar2-check" viewBox="0 0 16 16">
