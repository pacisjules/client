                    ...
                    <div class="d-flex">
                        ...
                        <div style="margin-left: 31px;width: 40%;">
                            ...
                            <form><label class="form-label">Search Product</label><input class="form-control" type="text" placeholder="Search Product ....." id="searcProductNow">
                                ...
                                <label class="form-label" style="margin-top: 28px;">PRODUCT: <span id="gettedProduct" style="color:green; font-weight:bold;"></span> </label></br><label class="form-label" style="margin-top: 28px;">ADD QUANTITY </label><input class="form-control" type="number" id="purchase_qty" style="margin-top: -6px;">
                                </br><label class="form-label" style="margin-top: 28px;">PRICE/ITEM</label><input class="form-control" type="number" id="purchase_price" style="margin-top: -6px;"></br>
