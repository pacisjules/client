...
$(function () {
  ...
  $("#EditInventory").click(function () {
    ...
    var container = $("#quantity").val();
    var qtyperbox = $("#alert_quantity").val();

    var company = localStorage.getItem("CoID");
    var UserID = localStorage.getItem("UserID");
    var row_id = parseInt(localStorage.getItem("rwo_id"));
    //Ajax Start!
    $.ajax({
      url: "functions/rowinventory/updateinventory.php",
      method: "POST",
      ...
      success: function (response) {
        ...
        localStorage.removeItem("rwo_id");
      },
      error: function (error) {
...
function View_inventoryRecord() {
  ...
  $.ajax({
    url:`functions/rowinventory/getRowinventorydatabyspt.php?company_id=${company_ID}`,
    method: "POST",
    context: document.body,
    success: function (response) {
      if (response) {
...
function SelectEditInventory(id, quantity, alert_quantity, name) {
  ...
  localStorage.setItem("rwo_id", id);
