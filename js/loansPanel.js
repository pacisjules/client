...
$("#NegoPrice").on("input", function () {
 ...
 $("#records_sell").click(function () {
  ...
  var amount_dues = cart.items.map(function(item) {
  ...
  // // Start AJAX request
  $.ajax({
    url: "functions/debts/recordmoredebts.php",
    method: "POST",
    dataType: 'json',
    data: {
