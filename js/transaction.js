$(document).ready(function () {
  ...
  $('#reportDate').on('change', function() {
    ...
    $.ajax({
      url:`functions/transaction/getalltransactionbyMethodpick.php?spt_id=${spt}&date=${selectedDate}`,
      method: "POST",
...
$.ajax({
  url:`functions/transaction/getalltransactionbyMethodfromto.php?spt_id=${spt}&fromDate=${fromDate}&toDate=${toDate}`,
  method: "POST",
  context: document.body,
  success: function (response) {
    if (response) {
...
$("#deleteBtnSales").on("click", function() {
  ...
  function View_transactionRecord() {
    // Retrieve values from localStorage
    var company_ID = localStorage.getItem("CoID");
    var spt_id = localStorage.getItem("SptID");
    ...
    $.ajax({
      url:`functions/transaction/getalltransactionbyMethod.php?spt_id=${spt_id}`,
      method: "POST",
      context: document.body,
      success: function (response) {
        if (response) {
