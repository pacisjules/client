$(document).ready(function () {
  ...
  $("#yesterdaysales").click(function () {
    ...
    View_YesterdaySalesRecord(shift_id);
  });
...
$(function () {
  ...
  $.ajax({
      url: `functions/sales/getallMonthlySalesshift.php?company=${company_ID}&spt=${sales_point_id}&startDate=${startDate}&endDate=${endDate}&shift_id=${shift_id}`,
      method: "POST",
...
$(function () {
  ...
  $.ajax({
    url:`functions/sales/getalldaysaleswithcompanysptyyestshift.php?date=${formattedDate}&company=${company_ID}&spt=${sales_point_id}&shift_id=${shift_id}`,
    method: "POST",
    context: document.body,
    success: function(response) {
      try {
...
const startDate = new Date(year, month - 1, 1); // Subtract 1 from month to make it zero-based
 ...
 endDate.setHours(23, 59, 59, 999); // Set time to end of the day
  ...
  // Make the AJAX request
  $.ajax({
      url: `functions/sales/getallMonthlySalesshift.php?company=${company_ID}&spt=${salesPointID}&startDate=${formattedStartDate}&endDate=${formattedEndDate}&shift_id=${shift_id}`,
      method: "POST",
      context: document.body,
      success: function(response) {
          try {
...
// Make the AJAX request
$.ajax({
    url: `functions/sales/getallYearlySalesshift.php?company=${company_ID}&spt=${salesPointID}&startDate=${startDate}&endDate=${endDate}&shift_id=${shift_id}`,
    method: "POST",
    context: document.body,
    success: function(response) {
        try {
...
function View_DaySalesRecord(shift_id) {
  ...
  $.ajax({
    url:`functions/sales/getalldaysaleswithcompanysptshift.php?date=${formattedDate}&company=${company_ID}&spt=${sales_point_id}&shift_id=${shift_id}`,
    method: "POST",
    context: document.body,
    success: function(response) {
      try {
...
function View_YesterdaySalesRecord(shift_id) {
