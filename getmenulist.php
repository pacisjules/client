...
$(document).ready(function() {
    ...
    "ajax": {
        "url": `functions/menu/getallproductsbysptdynamic.php?company=${company}&spt=${spt}`,
                ...
                "render": function(data, type, row, meta) {
                    ...
                    return `
                        <td class="d-flex justify-content-start align-items-center flex-wrap">
                            <button class="btn btn-success" type="button" data-bs-target="#edit_product_modal" data-bs-toggle="modal" onclick="setUpdates('${row.name}', '${row.price}',  '${row.description}', '${row.pid}')">
                            ...
                            <button class="btn btn-primary" type="button" style="width: 120.6875px; font-size:11px;" data-bs-target="#purchaseSalespoint_modal" data-bs-toggle="modal" onclick="SetSPProductID('${row.pid}')">
                            ...
                            <button class="btn btn-primary" type="button" style="background: rgb(223,139,78);font-weight: bold;border-color: rgb(255,255,255);width: 120.6875px; font-size:11px;" data-bs-target="#purchase_modal" data-bs-toggle="modal" onclick="getProductid('${row.pid}')">
                         ...
                         <button class="btn btn-primary" type="button" style="background: #ebdbff;font-weight: bold;border-color: rgb(255,255,255);width: 120.6875px; font-size:11px;" data-bs-target="#image_modal" data-bs-toggle="modal" onclick="localStorage.setItem('purchid', '${row.pid}'); getProductImage('${row.pid}')">
