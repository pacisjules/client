...
<head>
    ...
    <title>Users By Shift - SellEASEP</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-flex flex-row justify-content-between align-items-center">
                     ...
                     <h3 class="text-dark mb-4" style="font-weight: bold;font-size: 20px;">Users Shift Details of <span id="shiftname" style="color:green;"></span></h3>
                   ...
                   <div>
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <p class="text-primary m-0 fw-bold">Users Shift Information</p>
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td><strong>Last Names</strong></td>
