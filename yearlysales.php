...
<head>
    ...
    <title>Yearly Sales - SellEASEP</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-flex flex-row justify-content-between align-items-center">
                        <h3 class="text-dark mb-4" style="font-weight: bold;font-size: 36px; margin-top:25px;">Yearly
 Sales</h3> 
 <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#selectYearModal" type="button" style="font-size: 19px;font-weight: bold; background: rgb(0,26,53); color:white;" ><i class="far fa-star"></i>&nbsp;Select Year</button>
 <a href="sales.php"><button class="btn btn-primary" type="button" style="font-size: 19px;font-weight: bold; background: rgb(0,26,53); color:white;" ><i class="fas fa-sun"></i>&nbsp;View Daily Sales</button></a>  
                        <a href="weeklysales.php"><button class="btn btn-primary" type="button" style="font-size: 19px;font-weight: bold; background: rgb(0,26,53); color:white;" ><i class="fas fa-calendar-week"></i>&nbsp;View Weekly Sales</button></a>
                        <a href="monthlysales.php"><button class="btn btn-primary" type="button" style="font-size: 19px;font-weight: bold; background: rgb(0,26,53); color:white;" ><i class="far fa-star"></i>&nbsp;View Monthly Sales</button></a>
                    </div>
                    <div class="card shadow">
                       
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
    <p class="text-primary m-0 fw-bold">Yearly Sales Records, From <span id="start"></span> To <span id="end"></span></p>
    <button class="btn btn-primary" style="font-size: 15px; font-weight: bold;" id="generateYearlySalesReport">Print Report</button>
</div>
                                ...
                                <table class="table my-0" id="dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="font-size: 14px;">Price(RWF)</th>
                                            <th style="font-size: 14px;">Quantity</th>
                                            <th style="font-size: 14px;">Total amount (RWF)</th>
                                            <th style="font-size: 14px;">Benefit (RWF)</th>
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="delete_sales_modal">
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer"><button class="btn btn-light" type="button" data-bs-dismiss="modal">Cancel</button><button class="btn btn-danger" type="button"><i class="fa fa-trash" style="padding-right: 0px;margin-right: 11px;"></i>Delete</button></div>
            </div>
        </div>
    </div>
