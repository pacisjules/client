...
<head>
    ...
    <title>Customer Invoice Sales - SellEASEP</title>
    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <h3 class="text-dark mb-4 fw-bold" style="font-weight: 900;font-size: 22px; text-transform: uppercase;" >Customer Sales Details REPORT</h3>
        ...
        <a href="yearlyexpenses.php" class="btn btn-danger ">Yearly</a>
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3" style="display:flex;justify-content:space-between;">
                            <p class=" m-0 fw-bold" style="color:rgb(0,26,53);"> Customer Invoices Sales Records</p>
                        </div>
                        
                        <div class="card-body">
                            
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <?php include('getallsalesdetailbysessionid.php'); ?>
                            </div>
