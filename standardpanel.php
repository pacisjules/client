...
<head>
    ...
    <title>Standard Panel - SellEASP</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-flex flex-row justify-content-between align-items-center">
                        <h3 class="text-dark mb-4" style="font-weight: bold;font-size: 36px;">Standard Setting Panel</h3>
                    </div>
                    <div class="d-flex">
...
<!--                            
                    ...
                    <div class="card shadow" style="margin-top: 20px;">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Current Setted Standard Informations</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 text-nowrap">
                                ...
                                <table class="table my-0" id="dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="font-size: 11px;">Done Time</th>

                                        </tr>
                                    </thead>

                                    <tbody id="lastsetted_table">
                                    </tbody>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td><strong>Setted By</strong></td>
                                            <td><strong style="font-size: 11px;">Done Time</strong></td>
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="successmodal">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="color:green;" > You are successfully Set A Production Standard.!!</p>
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="errormodal">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="color:red;" > Something went wrong in setting standard.!!</p>
