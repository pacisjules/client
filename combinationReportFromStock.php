...
&nbsp;Monthly Inventory Report</button> 
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center" id="combinationBtnFromstock">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                               <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody id="sells_tablefrom">
                                       
                                    </tbody>
                                    <tfoot id="totalamfrom">
                                ...
                                <table class="table my-0" id="excelTable"  style="display: none;">
                                    ...
                                    <tbody id="excel_tablefrom">
                                       
                                    </tbody>
                                    <tfoot id="totalexcelfrom">
