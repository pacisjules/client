...
<head>
    ...
    <title>Proforma - SellEASEP</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-flex flex-row justify-content-between align-items-center">
                        <h3 class="text-dark mb-4" style="font-weight: bold;font-size: 36px;">Proforma Panel</h3>
                    </div>
                    <div class="d-flex">
                        ...
                        <div class="card shadow" style="width: 60%;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                    ...
                                    <div class="input-group mb-3" id="amadenisss" style="transition: ease-in-out 0.2s; flex-direction:row;">
...
<!-- 
                    ...
                    <div class="card shadow" style="margin-top: 20px;">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Current Proforma Informations</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 text-nowrap">
