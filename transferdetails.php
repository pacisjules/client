...
<head>
    ...
    <script src="js/transferdetails.js"></script>
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-flex flex-row justify-content-between align-items-center">
                     ...
                     <h3 class="text-dark mb-4" style="font-weight: bold;font-size: 20px;">Transfer Details of <span id="productname"></span></h3>
                   ...
                   <div>
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <p class="text-primary m-0 fw-bold">Transfer Details Information</p>
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td><strong>Container/Box</strong></td>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form><label class="form-label" style="margin-top: 12px;">Box/Container</label><input class="form-control" type="text" id="editbox"></form>
                     <form><label class="form-label" style="margin-top: 12px;">Items Per Container</label><input class="form-control" type="text" id="editquantity"></form>
                </div>
                <div class="modal-footer"><button class="btn btn-light" type="button" data-bs-dismiss="modal">Close</button><button class="btn btn-primary" type="button" id="editBtnTransfer">Edit</button></div>
            </div>
        </div>
    </div>
    <div class="modal fade" role="dialog" tabindex="-1" id="delete_sales_modal">
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" style="font-weight: bold;">Remove Transfer Data</h4><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Are sure you need to delete this transfer??</p>
                </div>
                <div class="modal-footer"><button class="btn btn-light" type="button" data-bs-dismiss="modal">Cancel</button><button class="btn btn-danger" type="button" id="deleteBtntrans"><i class="fa fa-trash" style="padding-right: 0px;margin-right: 11px;"></i>Delete</button></div>
            </div>
        </div>
    </div>
