                ...
                "render": function(data, type, row, meta) {
                    ...
                    return `
                        <td class="d-flex justify-content-start align-items-center flex-wrap">
                         ...
                         <button class="btn btn-primary" type="button" style="background: #ebdbff;font-weight: bold;border-color: rgb(255,255,255);width: 120.6875px; font-size:11px;" data-bs-target="#image_modal" data-bs-toggle="modal" onclick="getProductImage('${row.pid}')">
