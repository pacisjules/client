...
$query = "SELECT `sales_point_id`, `location` FROM `salespoint` WHERE `company_ID` = ?";
...
<head>
    ...
    <title>Transfer Request - SellEASEP</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-flex flex-row justify-content-between align-items-center">
                        <h3 class="text-dark mb-4" style="font-weight: 900;font-size: 22px; text-transform: uppercase;">REQUEST TRANSFER</h3>
                    </div>
                    <div class="d-flex">
                        ...
                        <div class="card shadow" style="width: 60%;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-end" >
                                    ...
                                    <i class="fa fa-shopping-cart" aria-hidden="true" style="margin-right: 5px;"></i>&nbsp; &nbsp;REQUEST NOW</button>
                                </div>
                        ...
                        <div style="margin-left: 31px;width: 40%;">
                            ...
                            <input class="form-control" type="text" placeholder="Search Product ....." id="searcProductNow">
                                ...
                                <button class="btn btn-primary" type="button" style="width: 100%;margin-top: 10px;font-weight: bold;" id="addCart"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart-plus">
                                    ...
                                    </svg>&nbsp;ADD</button><button class="btn btn-danger openModal" type="button" data-bs-target="#clear-modal" data-bs-toggle="modal" style="width: 100%;margin-top: 10px;font-weight: bold;"><i class="icon ion-android-cancel"></i>&nbsp; Cancel</button>
                    ...
                    <div class="card shadow" style="margin-top: 20px;">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Current Request Records</p>
                        </div>
                        <div class="card-body">
  ...
  <path d="M5 1a2 2 0 0 0-2 2v2H2a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h1v1a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-1h1a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-1V3a2 2 0 0 0-2-2H5zM4 3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2H4V3zm1 5a2 2 0 0 0-2 2v1H2a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v-1a2 2 0 0 0-2-2H5zm7 2v3a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1z"/>
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="AddPayowner">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" style="font-weight: bold; Text-transform: uppercase; font-size: 15px">Final request Information </h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
    <label for="addPayOwner" class="form-label">Store:</label>
    <select class="form-control" id="sales_point" name="sales_point" aria-describedby="emailHelp" onchange="fetchEmployees(this.value)">
        <option value="">Select a Location</option>
        <?php
        // Fetch sales points dynamically (from previous example)
        while ($row = $result->fetch_assoc()) {
            echo '<option value="' . htmlspecialchars($row['sales_point_id']) . '">' . htmlspecialchars($row['location']) . '</option>';
        }
        ?>
    </select>
</div>
...
<script>
    // JavaScript to fetch employees based on sales_point_id
    function fetchEmployees(salesPointId) {
        // Check if a valid salesPointId is selected
        if (salesPointId) {
            ...
            xhr.onload = function () {
                if (this.status === 200) {
                    ...
                    document.getElementById('supervisor').innerHTML = this.responseText;
                }
            };
            // Send the salesPointId to the server
            xhr.send('sales_point_id=' + encodeURIComponent(salesPointId));
        } else {
            // Clear the supervisor dropdown if no sales point is selected
            document.getElementById('supervisor').innerHTML = '<option value="">Select a Supervisor</option>';
        }
    }
</script>
    ...
    <script src="js/requestTransfer.js"></script>
