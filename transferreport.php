...
<head>
    ...
    <script src="js/salesresto.js"></script>
</head>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                   ...
                   <?php include('reporttransfer.php'); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6 text-nowrap">
                                    <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable" >
                                        <span>Period: </span> <span id="time_period" style="font-weight: bold; color: rgb(0,26,53);"></span> &nbsp;&nbsp;&nbsp;&nbsp;<span id="labeup"></span> <span id="benefitup"></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <table class="table my-0" id="dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="font-size: 14px;">Requested Qty</th>
                                            <th style="font-size: 14px;">Received Qty</th>
                                            <th style="font-size: 14px;">Requested By</th>
                                            <th style="font-size: 14px;">Supervised By</th>
