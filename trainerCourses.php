...
<head>
    ...
    <title>My Courses - SellEASEP</title>
    ...
    <script src="js/trainerCourses.js"></script>
                ...
                <div class="container-fluid">
                    <div class="d-flex flex-row justify-content-between align-items-center">
                     ...
                     &nbsp;Back</button><br><br>
                      ...
                      <h3 class="text-dark mb-4" style="font-weight: bold;font-size: 20px;">Courses Assigned to <span id="trainername"></span></h3>
                   ...
                   <div>
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <p class="text-primary m-0 fw-bold">Trainer courses Information</p>
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td><strong>Course Durationr</strong></td>
